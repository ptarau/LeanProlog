...
%% current_predicate(F/N) : true if predicate F/N is compiled or has a definition in the database
...
%% current_dynamic(F/N): backtracks over all dynamic predicates
