 ...
 */
public class LongStack implements Stateful {
   ...
   */
  public final void push(long v1) {
    // IO.dump("push:"+i);
    ++top;
    try {
      stack[top]=v1;
  ...
  public final long del_swap(long val) {
    int i=find(val);
    if(i>=0) {
      long tval=pop();
      if(i<=top)
  ...
  public final void update(int i,long val) {
    stack[i]=val;
  }
